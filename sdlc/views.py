        ...
        for event in events:
            ...
            if (event.type == 'message'):
                if (event.message.type == 'text'):
                    ...
                    imageOoriginalContentUrl = NGROK + '/static/linebot/'+event.message.id+'.png'
                    imagePreviewImageUrl = NGROK + '/static/linebot/'+event.message.id+'.png'
                    #print(2)
                    if isinstance(event, MessageEvent):
